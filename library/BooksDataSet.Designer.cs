...
namespace library {
    ...
    public partial class BooksDataSet : global::System.Data.DataSet {
        ...
        public partial class AuthorsDataTable : global::System.Data.TypedTableBase<AuthorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AuthorsRow AddAuthorsRow(string Name, string Surname, int Year) {
        ...
        public partial class AuthorsRow : global::System.Data.DataRow {
            ...
            public string Surname {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Surname\' в таблице \'Authors\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int Year {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Year\' в таблице \'Authors\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsYearNull() {
                return this.IsNull(this.tableAuthors.YearColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetYearNull() {
                this[this.tableAuthors.YearColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace library.BooksDataSetTableAdapters {
    ...
    public partial class AuthorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Authors] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Authors] ([Name], [Surname], [Year]) VALUES (@Name, @Surname, " +
                "@Year);\r\nSELECT Id, Name, Surname, Year FROM Authors WHERE (Id = SCOPE_IDENTITY(" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Authors] SET [Name] = @Name, [Surname] = @Surname, [Year] = @Year WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)));
SELECT Id, Name, Surname, Year FROM Authors WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Surname, Year FROM dbo.Authors";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Surname, global::System.Nullable<int> Original_Year) {
        ...
        public virtual int Insert(string Name, string Surname, global::System.Nullable<int> Year) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, global::System.Nullable<int> Year, int Original_Id, string Original_Name, string Original_Surname, global::System.Nullable<int> Original_Year, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, global::System.Nullable<int> Year, int Original_Id, string Original_Name, string Original_Surname, global::System.Nullable<int> Original_Year) {
            return this.Update(Name, Surname, Year, Original_Id, Original_Name, Original_Surname, Original_Year, Original_Id);
        }
    }
